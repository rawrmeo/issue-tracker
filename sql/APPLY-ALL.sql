-- ============================================================================
--  APPLY-ALL  �  everything the app needs, in one run
-- ----------------------------------------------------------------------------
--  Paste this whole file into Supabase -> SQL Editor -> New query -> Run.
--  It is safe to run more than once.
--
--  Contains, in order:
--    1. admin message to the reporter   (admin_note)
--    2. recycle bin / Archive           (deleted_at + functions)
--    3. automatic backups               (backups, app_settings, snapshot/restore)
--    4. push notifications              (subscriptions + settings)
--    5. the notification feed           (notifications + the trigger)
-- ============================================================================
